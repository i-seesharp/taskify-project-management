...
export default function MarketingPage() {
    return (
        <div className="flex flex-col items-center justify-center">
            <div className="flex flex-col items-center justify-center">
                <div className="flex items-center mb-4 border shadow-sm p-4
                ...
                mb-6 font-sans font-bold">
                    Taskify helps teams move
                </h1>
                <div className="text-3xl md:text-6xl bg-gradient-to-r
                from-fuchsia-600 to-pink-600 text-white px-4 font-sans font-semibold p-2
            ...
            <div 
            className={cn(
                "text-sm md:text-xl text-neutral-400 mt-4",
